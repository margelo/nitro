///
/// HybridChildrenTestViewComponent.mm
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/margelo/nitro
/// Copyright © Marc Rousavy @ Margelo
///

#import "HybridChildrenTestViewComponent.hpp"
#import <memory>
...
#import "HybridChildrenTestViewSpecSwift.hpp"
...
/**
 * Represents the React Native View holder for the Nitro "ChildrenTestView" HybridView.
 */
@interface HybridChildrenTestViewComponent: RCTViewComponentView
+ (BOOL)shouldBeRecycled;
@end

@implementation HybridChildrenTestViewComponent {
  std::shared_ptr<HybridChildrenTestViewSpecSwift> _hybridView;
...
+ (void) load {
  [super load];
  [RCTComponentViewFactory.currentComponentViewFactory registerComponentViewClass:[HybridChildrenTestViewComponent class]];
}

+ (react::ComponentDescriptorProvider) componentDescriptorProvider {
  return react::concreteComponentDescriptorProvider<HybridChildrenTestViewComponentDescriptor>();
}

- (instancetype) init {
  if (self = [super init]) {
    _props = HybridChildrenTestViewShadowNode::defaultSharedProps();
    std::shared_ptr<HybridChildrenTestViewSpec> hybridView = NitroTest::NitroTestAutolinking::createChildrenTestView();
    _hybridView = std::dynamic_pointer_cast<HybridChildrenTestViewSpecSwift>(hybridView);
    [self updateView];
  }
  return self;
}
...
- (void) updateView {
  // 1. Get Swift part
  NitroTest::HybridChildrenTestViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
...
- (void) updateProps:(const std::shared_ptr<const react::Props>&)props
  ...
  // 1. Downcast props
  const auto& newViewProps = *std::static_pointer_cast<const HybridChildrenTestViewProps>(props);
  const auto* oldViewProps = static_cast<const HybridChildrenTestViewProps*>(oldProps.get());
  NitroTest::HybridChildrenTestViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
...
+ (BOOL)shouldBeRecycled {
  return NitroTest::NitroTestAutolinking::isChildrenTestViewRecyclable();
}
