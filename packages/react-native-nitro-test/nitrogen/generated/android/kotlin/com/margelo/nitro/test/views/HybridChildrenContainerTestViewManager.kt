///
/// HybridChildrenContainerTestViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "ChildrenContainerTestView" Nitro HybridView.
 */
public class HybridChildrenContainerTestViewManager: ViewGroupManager<ViewGroup>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridChildrenContainerTestView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridChildrenContainerTestView::class.java)) {
  ...
  override fun getName(): String {
    return "ChildrenContainerTestView"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): ViewGroup {
    val hybridView = HybridChildrenContainerTestView(reactContext)
  ...
  override fun updateState(view: ViewGroup, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridChildrenContainerTestViewStateUpdater.updateViewProps(hybridView, newState, oldState)
