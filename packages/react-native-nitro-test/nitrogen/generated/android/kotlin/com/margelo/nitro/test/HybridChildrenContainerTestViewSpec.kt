///
/// HybridChildrenContainerTestViewSpec.kt
...
/**
 * A Kotlin class representing the ChildrenContainerTestView HybridObject.
 * Implement this abstract class to create Kotlin-based instances of ChildrenContainerTestView.
 */
@DoNotStrip
@Keep
@Suppress(
...
abstract class HybridChildrenContainerTestViewSpec: HybridView() {
  // Properties
  /**
  ...
  @DoNotStrip
  @Keep
  abstract fun getViewChildCount(): Double
  ...
  @DoNotStrip
  @Keep
  protected open class CxxPart(javaPart: HybridChildrenContainerTestViewSpec): HybridObject.CxxPart(javaPart) {
    // C++ JHybridChildrenContainerTestViewSpec::CxxPart::initHybrid(...)
    @FastNative
  ...
  companion object {
    protected const val TAG = "HybridChildrenContainerTestViewSpec"
  }
}
